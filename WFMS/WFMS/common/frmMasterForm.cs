...
{
    public partial class frmMasterDetailForm : MetroForm
    {
        ...
        public frmMasterDetailForm()
        {
            ...
            WFMS_txt.Entered += OnEntered;
            WFMS_txt.Left += OnLeft;
